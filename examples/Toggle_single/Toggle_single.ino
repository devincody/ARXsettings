...
void loop(){
  ...
  brd1.setAt2(CHANNEL, 14);                         //Set the value of At2 for only CHANNEL
  brd1.setAts(CHANNEL, 30);                         //Set the value of Ats for only CHANNEL
  ...
  brd1.setAt2(CHANNEL, 30);                         //Set the value of At2 for only CHANNEL
  brd1.setAts(CHANNEL, 0);                          //Set the value of Ats for only CHANNEL
